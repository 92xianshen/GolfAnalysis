...
#==============================================================================
# 20170601
# hyperparameter selection with 10-folds cross validation using gyro from 350 to 995 with model GolfVanillaCNN
...
# 20170420 Sensor selection: GyroX(5), GyroY(6), GyroZ(7)
...
# global parameters
opt = {
       'log_file': 'train_10folds_xval_log_gyro_350_995_GolfVanillaCNN.txt', 
       'niter': 100,
       ...
       'val_epoch': 10,
       'wt_decay': 1e-5,
       'loss_file_prefix': 'train_gyro_350_995_GolfVanillaCNN_loss_fold_',
       'loss_file_suffix': '.txt',
       'val_acc_file_prefix': 'val_acc_gyro_350_995_GolfVanillaCNN_fold_', 
       ...
       'model_name': 'golf_model_gyro_350_995_GolfVanillaCNN'
       }
