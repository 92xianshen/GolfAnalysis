...
#==============================================================================
# 20170601
# hyperparameter selection with 10-folds cross validation using all sensors from 350 to 995 with model GolfInception
...
# global parameters
opt = {
       'log_file': 'train_10folds_xval_log_all_sensors_350_995_GolfInception.txt', 
       'niter': 100,
       ...
       'val_epoch': 10,
       'wt_decay': 1e-5,
       'loss_file_prefix': 'train_all_sensors_350_995_GolfInception_loss_fold_',
       'loss_file_suffix': '.txt',
       'val_acc_file_prefix': 'val_acc_all_sensors_350_995_GolfInception_fold_', 
       ...
       'model_name': 'golf_model_all_sensor_350_995_GolfInception'
       }
...
#                         W=lasagne.init.GlorotUniform())
    ...
    params = lasagne.layers.get_all_params(golfInception.network['l_out'], trainable=True)
    grad = T.grad(loss, params)
    updates = lasagne.updates.adam(grad, params)
    
    val_prediction = lasagne.layers.get_output(golfInception.network['l_out'], input_var, 
                                               deterministic=True)
