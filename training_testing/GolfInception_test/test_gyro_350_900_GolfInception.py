...
opt = {
       ...
       'init_params': 'checkpoints_GolfInception/golf_model_gyro_350_900_GolfInception_epoch_99.npz',
       'sensor_selector': np.asarray([5, 6, 7]),
       'sample_selector': np.arange(350, 900),
       'y_pred_fname': 'y_pred_gyro_350_900_GolfInception.npz',
       'y_label_fname': 'y_label_gyro_350_900_GolfInception.npz'
       }
