...
opt = {
       ...
       'init_params': 'checkpoints_GolfInception/golf_model_acc_350_900_GolfInception_epoch_99.npz',
       'sensor_selector': np.asarray([2, 3, 4]),
       'sample_selector': np.arange(350, 900),
       'y_pred_fname': 'y_pred_acc_350_900_GolfInception.npz',
       'y_label_fname': 'y_label_acc_350_900_GolfInception.npz'
       }
