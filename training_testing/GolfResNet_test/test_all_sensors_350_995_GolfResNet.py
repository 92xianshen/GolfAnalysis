...
opt = {
       ...
       'init_params': 'checkpoints_GolfResNet/golf_model_all_sensors_350_995_GolfResNet_epoch_99.npz',
       'sensor_selector': np.asarray([0, 1, 2, 3, 4, 5, 6, 7]),
       'sample_selector': np.arange(350, 995),
       'y_pred_fname': 'y_pred_all_sensors_350_995_GolfResNet.npz',
       'y_label_fname': 'y_label_all_sensors_350_995_GolfResNet.npz'
       }
