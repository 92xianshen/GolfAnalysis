...
opt = {
       ...
       'init_params': 'checkpoints_GolfResNet/golf_model_acc_350_995_GolfResNet_epoch_99.npz',
       'sensor_selector': np.asarray([2, 3, 4]),
       'sample_selector': np.arange(350, 995),
       'y_pred_fname': 'y_pred_acc_350_995_GolfResNet.npz',
       'y_label_fname': 'y_label_acc_350_995_GolfResNet.npz'
       }
