...
opt = {
       ...
       'init_params': 'checkpoints_GolfResNet/golf_model_acc_350_800_GolfResNet_epoch_99.npz',
       'sensor_selector': np.asarray([2, 3, 4]),
       'sample_selector': np.arange(350, 800),
       'y_pred_fname': 'y_pred_acc_350_800_GolfResNet.npz',
       'y_label_fname': 'y_label_acc_350_800_GolfResNet.npz'
       }
