...
opt = {
       ...
       'init_params': 'checkpoints_GolfVanillaCNN/golf_model_gyro_350_995_GolfVanillaCNN_epoch_99.npz',
       'sensor_selector': np.asarray([5, 6, 7]),
       'sample_selector': np.arange(350, 995),
       'y_pred_fname': 'y_pred_gyro_350_995_GolfVanillaCNN.npz',
       'y_label_fname': 'y_label_gyro_350_995_GolfVanillaCNN.npz'
       }
...
lasagne.layers.set_all_param_values(golfVanillaCNN.network['l_out'], param_values)
