...
opt = {
       ...
       'init_params': 'checkpoints_GolfVanillaCNN/golf_model_sg_350_800_GolfVanillaCNN_epoch_99.npz',
       'sensor_selector': np.asarray([0, 1]),
       'sample_selector': np.arange(350, 800),
       'y_pred_fname': 'y_pred_sg_350_800_GolfVanillaCNN.npz',
       'y_label_fname': 'y_label_sg_350_800_GolfVanillaCNN.npz'
       }
