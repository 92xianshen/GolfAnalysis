...
opt = {
       ...
       'init_params': 'checkpoints_GolfVanillaCNN/golf_model_acc_350_850_GolfVanillaCNN_epoch_99.npz',
       'sensor_selector': np.asarray([2, 3, 4]),
       'sample_selector': np.arange(350, 850),
       'y_pred_fname': 'y_pred_acc_350_850_GolfVanillaCNN.npz',
       'y_label_fname': 'y_label_acc_350_850_GolfVanillaCNN.npz'
       }
